...
// const pokemonPromise = fetchPokemon('pifkachu')
...
// pokemonPromise.then(pikachu => pokemon = pikachu).catch(err => error = err)
const pikachuResource = createResource(fetchPokemon('pikachu'))

function PokemonInfo() {
  // 🐨 if there's no pokemon yet, then throw the pokemonPromise
  // 💰 (no, for real. Like: `throw pokemonPromise`)
  const pokemon = pikachuResource.read()
